...
public interface IFriendRequestRepository
{
    ...
    Task<IReadOnlyList<FriendRequest>> GetAllBetweenUsersAsync(Guid firstUserId, Guid secondUserId, CancellationToken cancellationToken = default);
    ...
    void RemoveRange(IEnumerable<FriendRequest> requests);
}
