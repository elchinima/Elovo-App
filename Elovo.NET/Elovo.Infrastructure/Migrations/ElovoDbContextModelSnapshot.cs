...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Elovo.Domain.UserEmail", b =>
                {
            ...
            modelBuilder.Entity("Elovo.Domain.UserPremium", b =>
                {
                    ...
                    b.Property<bool>("IsExtendedVoiceMessagesEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);

                    b.Property<bool>("IsPremiumBadgeVisible")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);

                    b.Property<bool>("IsRawImageUploadsEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);

                    b.Property<bool>("IsVideoUploadsEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("Elovo.Domain.UserEmail", b =>
                {
                    b.HasOne("Elovo.Domain.User", "User")
                        ...
                        .HasForeignKey("Elovo.Domain.UserEmail", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
